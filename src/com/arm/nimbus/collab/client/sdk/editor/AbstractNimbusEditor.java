package com.arm.nimbus.collab.client.sdk.editor;

import java.util.List;
import java.util.Map;
import java.util.Set;

import com.arm.nimbus.collab.client.model.AbstractEntityProxy;
...
public abstract class AbstractNimbusEditor<T extends BaseProxy> extends Composite implements
		Editor<T>, IsWidget, HasEditorErrors<T> {
